...
LAYOUT_SCENE_PATHS = [
	...
	Path("input_test/3og_example/output_bedroom_1/generated_scene.json"),
	Path("input_test/3og_example/output_bedroom_2/generated_scene.json"),
	Path("input_test/3og_example/output_bedroom_3/generated_scene.json"),
]
